...
import de.voicehired.wachak.core.storage.APCleanupAlgorithm;
import de.voicehired.wachak.core.storage.APNullCleanupAlgorithm;
import de.voicehired.wachak.core.storage.APQueueCleanupAlgorithm;
...
public class PreferencesTest extends ActivityInstrumentationTestCase2<PreferenceActivity>  {
    ...
    public void testSwitchTheme() {
        ...
        int otherTheme;
        if(theme == de.voicehired.wachak.core.R.style.Theme_AntennaPod_Light) {
