...
import de.voicehired.wachak.core.util.playback.Timeline;
...
public class TimelineTest extends InstrumentationTestCase {
    ...
    public void testIsTimecodeLink() throws Exception {
        ...
        assertFalse(Timeline.isTimecodeLink("http://wachak/timecode/123123"));
        assertFalse(Timeline.isTimecodeLink("wachak://timecode/"));
        assertFalse(Timeline.isTimecodeLink("wachak://123123"));
        assertFalse(Timeline.isTimecodeLink("wachak://timecode/123123a"));
        assertTrue(Timeline.isTimecodeLink("wachak://timecode/123"));
        assertTrue(Timeline.isTimecodeLink("wachak://timecode/1"));
    }
    ...
    public void testGetTimecodeLinkTime() throws Exception {
        ...
        assertEquals(123, Timeline.getTimecodeLinkTime("wachak://timecode/123"));
