package de.voicehired.wachak.core.util.id3reader;
...
import de.voicehired.wachak.core.util.id3reader.model.FrameHeader;
import de.voicehired.wachak.core.util.id3reader.model.TagHeader;
