package de.voicehired.wachak.core.service.playback;
...
import de.voicehired.wachak.core.receiver.MediaButtonReceiver;
import de.voicehired.wachak.core.storage.DBTasks;
import de.voicehired.wachak.core.storage.DBWriter;
import de.voicehired.wachak.core.util.IntList;
import de.voicehired.wachak.core.util.QueueAccess;
...
public class PlaybackService extends Service {
    public static final String FORCE_WIDGET_UPDATE = "de.voicehired.wachak.FORCE_WIDGET_UPDATE";
    public static final String STOP_WIDGET_UPDATE = "de.voicehired.wachak.STOP_WIDGET_UPDATE";
    /**
     * Logging tag
     */
     ...
     */
    public static final String EXTRA_SHOULD_STREAM = "extra.de.voicehired.wachak.core.service.shouldStream";
    /**
     * True if playback should be started immediately after media has been
     * prepared.
     */
    public static final String EXTRA_START_WHEN_PREPARED = "extra.de.voicehired.wachak.core.service.startWhenPrepared";

    public static final String EXTRA_PREPARE_IMMEDIATELY = "extra.de.voicehired.wachak.core.service.prepareImmediately";

    public static final String ACTION_PLAYER_STATUS_CHANGED = "action.de.voicehired.wachak.core.service.playerStatusChanged";
    public static final String EXTRA_NEW_PLAYER_STATUS = "extra.de.voicehired.wachak.service.playerStatusChanged.newStatus";
    private static final String AVRCP_ACTION_PLAYER_STATUS_CHANGED = "com.android.music.playstatechanged";
    private static final String AVRCP_ACTION_META_CHANGED = "com.android.music.metachanged";

    public static final String ACTION_PLAYER_NOTIFICATION = "action.de.voicehired.wachak.core.service.playerNotification";
    public static final String EXTRA_NOTIFICATION_CODE = "extra.de.voicehired.wachak.core.service.notificationCode";
    public static final String EXTRA_NOTIFICATION_TYPE = "extra.de.voicehired.wachak.core.service.notificationType";

    /**
     * If the PlaybackService receives this action, it will stop playback and
     * try to shutdown.
     */
    public static final String ACTION_SHUTDOWN_PLAYBACK_SERVICE = "action.de.voicehired.wachak.core.service.actionShutdownPlaybackService";
     ...
     */
    public static final String ACTION_SKIP_CURRENT_EPISODE = "action.de.voicehired.wachak.core.service.skipCurrentEpisode";

    /**
     * If the PlaybackService receives this action, it will pause playback.
     */
    public static final String ACTION_PAUSE_PLAY_CURRENT_EPISODE = "action.de.voicehired.wachak.core.service.pausePlayCurrentEpisode";


    /**
     * If the PlaybackService receives this action, it will resume playback.
     */
    public static final String ACTION_RESUME_PLAY_CURRENT_EPISODE = "action.de.voicehired.wachak.core.service.resumePlayCurrentEpisode";
    ...
    /**
     * @see de.voicehired.wachak.core.service.playback.PlaybackServiceMediaPlayer#seekToChapter(de.voicehired.wachak.core.feed.Chapter)
     */
