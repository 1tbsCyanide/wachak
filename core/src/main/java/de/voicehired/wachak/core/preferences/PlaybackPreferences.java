...
public class PlaybackPreferences implements SharedPreferences.OnSharedPreferenceChangeListener {
     ...
     * object.
     */
    public static final String PREF_CURRENTLY_PLAYING_FEED_ID = "de.voicehired.wachak.preferences.lastPlayedFeedId";
     ...
     */
    public static final String PREF_CURRENTLY_PLAYING_FEEDMEDIA_ID = "de.voicehired.wachak.preferences.lastPlayedFeedMediaId";
     ...
     */
    public static final String PREF_CURRENTLY_PLAYING_MEDIA = "de.voicehired.wachak.preferences.currentlyPlayingMedia";

    /**
     * True if last played media was streamed.
     */
    public static final String PREF_CURRENT_EPISODE_IS_STREAM = "de.voicehired.wachak.preferences.lastIsStream";

    /**
     * True if last played media was a video.
     */
    public static final String PREF_CURRENT_EPISODE_IS_VIDEO = "de.voicehired.wachak.preferences.lastIsVideo";

    /**
     * The current player status as int.
     */
    public static final String PREF_CURRENT_PLAYER_STATUS = "de.voicehired.wachak.preferences.currentPlayerStatus";
