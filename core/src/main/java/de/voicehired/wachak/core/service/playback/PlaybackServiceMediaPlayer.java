...
import de.voicehired.wachak.core.util.RewindAfterPauseUtils;
import de.voicehired.wachak.core.util.playback.AudioPlayer;
import de.voicehired.wachak.core.util.playback.IPlayer;
import de.voicehired.wachak.core.util.playback.Playable;
import de.voicehired.wachak.core.util.playback.VideoPlayer;
...
public class PlaybackServiceMediaPlayer implements SharedPreferences.OnSharedPreferenceChangeListener {
     ...
     *
     * @see #playMediaObject(de.voicehired.wachak.core.util.playback.Playable, boolean, boolean, boolean)
     */
