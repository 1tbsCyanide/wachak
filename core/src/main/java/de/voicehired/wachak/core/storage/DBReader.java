package de.voicehired.wachak.core.storage;
...
import de.voicehired.wachak.core.feed.ID3Chapter;
import de.voicehired.wachak.core.feed.SimpleChapter;
import de.voicehired.wachak.core.feed.VorbisCommentChapter;
...
import de.voicehired.wachak.core.util.LongIntMap;
import de.voicehired.wachak.core.util.LongList;
import de.voicehired.wachak.core.util.comparator.DownloadStatusComparator;
import de.voicehired.wachak.core.util.comparator.FeedItemPubdateComparator;
import de.voicehired.wachak.core.util.comparator.PlaybackCompletionDateComparator;
import de.voicehired.wachak.core.util.flattr.FlattrThing;
 ...
 * This class will use the {@link de.voicehired.wachak.core.feed.EventDistributor} to notify listeners about changes in the database.
 */
public final class DBReader {
     ...
     * list in a {@link de.voicehired.wachak.core.util.QueueAccess} object for easier access to the queue's properties.
     */
