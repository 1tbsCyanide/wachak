package de.voicehired.wachak.core.util.flattr;
...
import de.voicehired.wachak.core.asynctask.FlattrTokenFetcher;
...
public class FlattrUtils {
    ...
    private static final String HOST_NAME = "de.voicehired.wachak";

    private static final String PREF_ACCESS_TOKEN = "de.voicehired.wachak.preference.flattrAccessToken";
